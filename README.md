...
```bash
git clone https://github.com/shianjeng/sonogram.git
cd sonogram && pip install -e .
```
...
⚠ 03 - also-bad.flac        cut= 18.8k   90%  → mp3 ~192 kbps
...
Griffin-Lim error decreasing monotonically with iteration count.
...
MIT. The demo track is generated by `make_demo_audio.py`; do not commit
